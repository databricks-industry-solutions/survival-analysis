...
# MAGIC   * Shown below the model summary, these bounds can also be viewed visually. Although it's not seen here, note that when viewing the bounds in this way, a variable can be deemed as not significant when its corresponding box-and-whisker plot crosses the value 1.
# MAGIC 
